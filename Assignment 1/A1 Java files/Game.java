/**
 * This class creates a single NFL game. Can also output the game
...
public class Game {
    ...
    /**
     * This constructs the game object using the parameters.
     */
    public Game(String year, String week, String day, String home, String homeScore, String away, String awayScore,
            String date, String result, String homeYards, String awayYards, String homeTO, String awayTO) {
        super();
        this.year = year;
        this.week = week;
        this.day = day;
    ...
    public String toString() {
        return year + "," + week + "," + day + "," + home + "," + homeScore + "," + away + "," + awayScore + "," + date
                + "," + result + "," + homeYards + "," + awayYards + "," + homeTO + "," + awayTO;
    }
